...
import type { QRCodeActionData, QRCodeData } from "../types/qrCodeData";
...
export default function QRCodeForm() {
  ...
  const [initialFormState, setInitialFormState] = useState<QRCodeData>(qrCode);
          ...
          <s-section heading="QR Code information">
            <s-stack gap="base">
              <s-text-field
                ...
                onInput={(e) =>
                  setFormState({ ...formState, title: (e.target as HTMLInputElement).value })
                }
              ></s-text-field>
              <s-stack gap="large-500" justifyContent="space-between" alignItems="start">
                <s-select
                  name="destination"
                  label="Scan destination"
                  value={formState.destination}
                  onChange={(e) =>
                    setFormState({ ...formState, destination: (e.target as HTMLSelectElement).value })
                  }
                >
                  <s-option
                    value="product"
              ...
              <s-stack gap="base">
                ...
                >
                  ...
                  <s-button
                    ...
                    download={initialFormState?.image}
                    variant="primary"
                  >
                    Download
                  </s-button>

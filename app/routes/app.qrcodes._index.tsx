...
const QRTable = ({ qrCodes }: { qrCodes: QRCodeData[] }) => (
...
const QRTableRow = ({ qrCode }: { qrCode: QRCodeData }) => (
  <s-table-row id={`${qrCode.id}`}>
    <s-table-cell>
...
export default function Index() {
  ...
  return (
    <s-page heading="QR codes">
      <s-button variant="secondary" slot="secondary-actions" href="/app/qrcodes/new">
        Create QR code
      </s-button>
      {qrCodes.length === 0 ? (
        <EmptyQRCodeState />
